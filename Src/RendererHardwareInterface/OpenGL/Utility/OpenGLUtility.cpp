...
namespace Renderer
{
    GLenum OpenGLUtility::GetShaderDataTypeGlEnum(ShaderDataType type)
    {
        switch (type)
        {
    ...
    bool OpenGLUtility::CheckShaderState(unsigned int shaderId)
    {
        GLint flag;
    ...
    std::string OpenGLUtility::GetShaderInfoLog(unsigned int shaderId)
    {
        CheckInfoBuffer();
    ...
    std::string OpenGLUtility::GetProgramInfoLog(unsigned int programId)
    {
        CheckInfoBuffer();
    ...
    void OpenGLUtility::CheckInfoBuffer()
    {
